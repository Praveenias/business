  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* First Card */}
        <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg hover:scale-105 transform transition duration-300 ease-in-out flex flex-col justify-center items-center">
          <div className="text-4xl font-bold">99.2%</div>
          <div className="text-lg font-medium mt-2">Successful Busines</div>
        ...
        {/* Second Card */}
        <div className="bg-purple-700 rounded-2xl p-8 text-white hover:shadow-lg hover:scale-105 transform transition duration-300 ease-in-out flex flex-col justify-center items-center">
